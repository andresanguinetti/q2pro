...
static void CL_ParsePrint(void)
{
    ...
    if (cl_chat_sound->integer > 1)
        ...
        if (cl_actionsounds->value) {
            ...
            else if (cl_mk23_sound->integer == 1)
            ...
            else if (cl_mp5_sound->integer == 1)
            ...
            else if (cl_ssg_sound->integer == 1)
            ...
            else if (cl_sknife_sound->integer == 1)
            ...
            else if (cl_tknife_sound->integer == 1)
